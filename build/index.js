...
function Edit({
  ...
  const {
    ...
    getEditedPostContent: select(_wordpress_editor__WEBPACK_IMPORTED_MODULE_6__.store).getEditedPostContent(),
    getCurrentPostType: select(_wordpress_editor__WEBPACK_IMPORTED_MODULE_6__.store).getCurrentPostType(),
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    ...
    const parsedDocument = parser.parseFromString(getEditedPostContent, "text/html");
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    href: `#${tag.id}`
  }, tag.text)))) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Error, null));
}
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/dynamic-blog-sidebar-block","version":"0.1.0","title":"Dynamic Blog Sidebar Block","category":"widgets","icon":"smiley","description":"To make navigating through the h2 tags on the page easier, dynamically get them from the post text.","example":{},"attributes":{"h2tags":{"type":"array"},"postId":{"type":"number"}},"supports":{"color":{"background":false,"text":true},"html":false,"typography":{"fontSize":false}},"textdomain":"dynamic-blog-sidebar-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkdynamic_blog_sidebar_block"] = globalThis["webpackChunkdynamic_blog_sidebar_block"] || [];
